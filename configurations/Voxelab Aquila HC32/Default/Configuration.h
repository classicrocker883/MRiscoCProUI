/** Aquila HC32 Default-No Probe ProUI
...
#define STRING_CONFIG_H_AUTHOR "Miguel A. Risco-Castillo (MRiscoC)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.0, -7.0, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_PROBE_FEEDRATE_FAST  (9*60) // (mm/min)

// Feedrate for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW   (150) // (mm/min)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MAX_SAVED_MESHES    5           // Maximum number of meshes to store to EEPROM. Use 0 to disable saving.
...
// Professional firmware features:
  ...
  #define ALT_COLOR_MENU 0      // Color palette options >> 0 = Voxelab Default | 1 = Alternate Aquila | 2 = Ender-3 V2 Default
