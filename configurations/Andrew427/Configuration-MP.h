 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.0, -9.0, -0.80 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
// Professional firmware features:
  ...
  #define ALT_COLOR_MENU 1      // Color palette options >> 0 = Voxelab Default | 1 = Alternate Aquila | 2 = Ender-3 V2 Default
