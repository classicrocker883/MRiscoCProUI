...
const TBItem_t TBItemA[] = {
  ...
  OPTARG(ADVANCED_PAUSE_FEATURE, TB_ITEM(ICON_FilMan, MSG_FILAMENTCHANGE, ChangeFilament))
  OPTARG(FILAMENT_LOAD_UNLOAD_GCODES, TB_ITEM(ICON_FilUnload, MSG_FILAMENTUNLOAD, UnloadFilament))
  OPTARG(FILAMENT_LOAD_UNLOAD_GCODES, TB_ITEM(ICON_FilLoad, MSG_FILAMENTLOAD, LoadFilament))
};
