...
// inline uint32_t swap32(const uint32_t value) { return (value &0xFFFF)<<32|(value&0xFFF)<<24|(value&0xFFU)<<16|(value>>8);}
// inline uint32_t swap32(const uint32_t value) {re}
