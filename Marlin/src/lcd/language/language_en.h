...
namespace LanguageNarrow_en {
  ...
  LSTR MSG_PREHEAT_M_SETTINGS             = _UxGT("Preheat $ Sett.");
  ...
  LSTR MSG_CONTROL_RETRACT_SWAP           = _UxGT("Swap Retract mm");
  ...
  LSTR MSG_CONTROL_RETRACT_RECOVER_SWAP   = _UxGT("Swap Recover Extra");
  ...
  LSTR MSG_TMC_HYBRID_THRS                = STR_HYBRID_THRESHOLD;
  LSTR MSG_TMC_AHYBRID_THRS               = STR_A _UxGT(" " STR_HYBRID_THRESHOLD);
  LSTR MSG_TMC_BHYBRID_THRS               = STR_B _UxGT(" " STR_HYBRID_THRESHOLD);
  LSTR MSG_TMC_CHYBRID_THRS               = STR_C _UxGT(" " STR_HYBRID_THRESHOLD);
  LSTR MSG_TMC_EHYBRID_THRS               = STR_E _UxGT(" " STR_HYBRID_THRESHOLD);
  ...
  LSTR MSG_TMC_STEALTHCHOP                = STR_TMC_STEALTH;
  LSTR MSG_TMC_STEALTH_ENABLED            = STR_TMC_STEALTH _UxGT(" Enabled");
  LSTR MSG_TMC_ASTEALTH                   = STR_A _UxGT(" " STR_TMC_STEALTH);
  LSTR MSG_TMC_BSTEALTH                   = STR_B _UxGT(" " STR_TMC_STEALTH);
  LSTR MSG_TMC_CSTEALTH                   = STR_C _UxGT(" " STR_TMC_STEALTH);
  LSTR MSG_TMC_ESTEALTH                   = STR_E _UxGT(" " STR_TMC_STEALTH);
...
namespace LanguageWide_en {
  using namespace LanguageNarrow_en;
    ...
    LSTR MSG_HOTEND_PID_SETTINGS          = STR_HOTEND_PID _UxGT(" Settings");
    LSTR MSG_BED_PID_SETTINGS             = STR_BED_PID _UxGT(" Settings");
    LSTR MSG_CHAMBER_PID_SETTINGS         = STR_CHAMBER_PID _UxGT(" Settings");
