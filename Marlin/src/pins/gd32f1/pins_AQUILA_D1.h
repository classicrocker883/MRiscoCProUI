...
#define Z_MIN_PIN                           PB1     // Standard Endstop or Z_Probe endstop function
...
//
  ...
  #define FIL_RUNOUT_PIN                    PA0   // PC0 XMAX plug on PCB used as filament runout sensor on Alfawise boards (inverting true)
#endif

//
// Steppers
//
#define X_ENABLE_PIN                        PE5   // PB5
#define X_STEP_PIN                          PE4   // PB4
#define X_DIR_PIN                           PB5   // PB3

#define Y_ENABLE_PIN                        PB3   // PB8
#define Y_STEP_PIN                          PD6   // PB7
#define Y_DIR_PIN                           PD5   // PB6

#define Z_ENABLE_PIN                        PD3   // PE1
#define Z_STEP_PIN                          PD1   // PE0
#define Z_DIR_PIN                           PD0   // PB9

#define E0_ENABLE_PIN                       PC14  // PE4
#define E0_STEP_PIN                         PC13  // PE3
#define E0_DIR_PIN                          PE6   // PE2

//
// Temperature Sensors
//
#define TEMP_0_PIN                          PC1   // PA0 (Nozzle 100K/3950 thermistor)
#define TEMP_BED_PIN                        PC2   // PA1 (Hot Bed 100K/3950 thermistor)

//
// Heaters / Fans
//
#define HEATER_0_PIN                        PA7   // PD3 (Nozzle Heat Mosfet)
#define HEATER_BED_PIN                      PA6   // PA8 (Hot Bed Mosfet)
...
#define MOTOR_CURRENT_PWM_Y_PIN          PB7   // VREF2/3 CONTROL XY
#define MOTOR_CURRENT_PWM_Z_PIN          PB6   // VREF4 CONTROL Z
#define MOTOR_CURRENT_PWM_E_PIN          PB9   // VREF4 CONTROL Z
#define MOTOR_CURRENT_PWM_RANGE           1500  // (255 * (1000mA / 65535)) * 257 = 1000 is equal 1.6v Vref in turn equal 1Amp
#ifndef DEFAULT_PWM_MOTOR_CURRENT
  #define DEFAULT_PWM_MOTOR_CURRENT {500,500,450}
  // #define DEFAULT_PWM_MOTOR_CURRENT {500,500,650}
#endif
...
//
  ...
  #define IIC_EEPROM_SDA                    PE7
  #define IIC_EEPROM_SCL                    PE8
