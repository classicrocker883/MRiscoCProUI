...
FORCE_INLINE void probe_specific_action(const bool deploy) {
  DEBUG_SECTION(log_psa, "Probe::probe_specific_action", DEBUGGING(LEVELING));
    ...
    TERN_(DWIN_LCD_PROUI, Popup_Continue(ICON_BLTouch, ds_fstr, F("")));
    TERN_(HAS_RESUME_CONTINUE, wait_for_user_response());
 ...
 */
  ...
  float Probe::run_z_probes(const bool sanity_check/*=true*/, const float z_min_point/*=Z_PROBE_LOW_POINT*/, const float z_clearance/*=Z_TWEEN_SAFE_CLEARANCE*/) {
