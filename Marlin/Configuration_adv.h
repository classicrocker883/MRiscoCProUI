...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  2000    // (ms) Interval between automatic screen updates
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1600       // (steps or mm) Steps or millimeter distance for each Z babystep
